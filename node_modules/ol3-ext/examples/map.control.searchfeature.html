...
<html>
<head>
	<title>OL3-ext: Search feature control</title>
	...
	<link rel="stylesheet" href="../control/searchfeaturecontrol.css" />
	<script type="text/javascript" src="../control/searchfeaturecontrol.js"></script>
...
<body >
	...
	<a href="../index.html">
		<h1>OL3-ext: Search feature control</h1>
	</a>
	...
	<div class="info">
		...
		<ul>
			...
			<li>
				You can define a <i>property</i> to display in the list (or a function to retrieve it).
			</li>
			<li>
		...
		<br/>
		<i>ol.control.SearchFeature</i> requires jQuery.
	</div>
	...
	<div class="options">
		...
		<ul>
			...
			<li>
				search property:
				<select onchange="search.search(''); search.set('property', $(this).val());">
